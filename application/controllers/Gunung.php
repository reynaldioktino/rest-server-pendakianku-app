...
//$this->response(array("status"=>"success"));
	function gunung_get(){
		$get_gunung = $this->db->query("SELECT g.id_gunung, g.nama, g.deskripsi ,g.foto, g.lokasi FROM gunung as g")->result();
		$this->response(array("status"=>"success","result" => $get_gunung));
	}
	function user_post() {
